...
export const projects = [
  ...
  {
    title: 'VirtualR',
    description: 'A Single Page Frontend UI made using React and Tailwind ',
    image: '/virtualr.png?height=200&width=300',
    liveLink: 'https://virtualr-alpha-virid.vercel.app/',
    githubLink: 'https://github.com/asifshaikh/virtualr',
  },
  {
    title: 'Portfolio',
    description:
  ...
  },
  {
    ...
    description:
      'A Java-based billing management system with Swing GUI and MySQL database for automated billing processes and invoice generation.',
...
export const socialLinks = [
  {
    icon: Facebook,
    label: 'Facebook',
    link: 'https://www.facebook.com/profile.php?id=100004311934012',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    link: 'https://www.linkedin.com/in/mohammedshaikh30/',
  },
  {
    icon: Instagram,
    label: 'Instagram',
    link: 'https://www.instagram.com/axif.16/',
  },
